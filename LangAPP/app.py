...
def load_llm(openai_api_key):
    ...
    conversation=ConversationChain(llm,memory=memory)
    return llm
...
with col3:
    translate_input= st.selectbox("Which language do you want to translate your text?",('English','Turkish','German','Spanish','Portuguese'))
